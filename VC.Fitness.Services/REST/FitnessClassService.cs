...
namespace VelocityCoders.FitnessSchedule.Services.REST
{
    ...
    public class FitnessClassService : IFitnessClassService
    {
        ...
        public FitnessClassDTOCollection GetFitnessClassesByInstructor(string instructorId)
        {
            FitnessClassCollection list = FitnessClassManager.GetCollection(instructorId.ToInt());
            return this.FitnessClassCollectionToDTO(list);
        }
        #endregion
